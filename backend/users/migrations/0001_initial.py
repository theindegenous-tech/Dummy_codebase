# Generated by Django 4.0.6 on 2022-07-14 10:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_id', models.ManyToManyField(blank=True, to='the_indegenous_backend.book')),
            ],
        ),
        migrations.CreateModel(
            name='Location',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('bookmarks', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='users.bookmark')),
        ...
        migrations.AddField(
            model_name='bookmark',
            name='locations',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='users.location'),
        ),
        migrations.CreateModel(
            name='User',
            fields=[
